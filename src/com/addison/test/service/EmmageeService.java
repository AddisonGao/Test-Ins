 ...
 *
 */
package com.addison.test.service;
...
import com.addison.test.activity.MainPageActivity;
import com.addison.test.utils.Constants;
import com.addison.test.utils.CpuInfo;
import com.addison.test.utils.CurrentInfo;
import com.addison.test.utils.EncryptData;
import com.addison.test.utils.MailSender;
import com.addison.test.utils.MemoryInfo;
import com.addison.test.utils.MyApplication;
import com.addison.test.utils.ProcessInfo;
import com.addison.test.utils.Programe;
import com.addison.test.utils.Settings;
import com.addison.test.R;
...
public class EmmageeService extends Service {
	...
	public static final String SERVICE_ACTION = "com.addison.testService";
	...
	public void onCreate() {
		...
		des = new EncryptData("Addison_Test");
	...
	private void createResultCsv() {
		...
		if (android.os.Environment.getExternalStorageState().equals(android.os.Environment.MEDIA_MOUNTED)) {
			...
			resultFilePath = "/sdcard" + File.separator + "Addison_TestResult_" + mDateTime + ".csv";
			// resultFilePath =
			// android.os.Environment.getExternalStorageDirectory() +
			// File.separator + "Emmagee_TestResult_" + mDateTime + ".csv";
		} else {
			resultFilePath = getBaseContext().getFilesDir().getPath() + File.separator + "Addison_TestResult_" + mDateTime + ".csv";
		}
		try {
